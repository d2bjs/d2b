...
# {#bubble_pack_apply}
[#](#bubble_pack_apply) *bubblePack*(*context*)
...
# {#bubble_pack_type}
[#](#bubble_pack_type) bubblePack.**type**()

Returns the string `bubblePack`.

# {#bubble_pack_point}
[#](#bubble_pack_point) bubblePack.**point**([*point*])
...
# {#bubble_pack_graphs}
[#](#bubble_pack_graphs) bubblePack.**graphs**([*graphs*])
...
[#](#bubble_pack_duration) bubblePack.**duration**([*duration*])
...
[#](#bubble_pack_tendancy) bubblePack.**tendancy**([*tendancy*])
...
[#](#bubble_pack_tooltip_graph) bubblePack.**tooltipGraph**([*tooltip_graph*])
...
# {#bubble_pack_shift}
[#](#bubble_pack_shift) bubblePack.**shift**([*shift*])
...
# {#bubble_pack_symbol}
[#](#bubble_pack_symbol) bubblePack.**symbol**([*symbol*])
...
# {#bubble_pack_key}
[#](#bubble_pack_key) bubblePack.**key**([*key*])
...
# {#bubble_pack_color}
[#](#bubble_pack_color) bubblePack.**color**([*color*])
...
# {#bubble_pack_values}
[#](#bubble_pack_values) bubblePack.**values**([*values*])
...
# {#bubble_pack_px}
[#](#bubble_pack_px) bubblePack.**px**([*px*])
...
# {#bubble_pack_py}
[#](#bubble_pack_py) bubblePack.**py**([*py*])
...
# {#bubble_pack_pcolor}
[#](#bubble_pack_pcolor) bubblePack.**pcolor**([*color*])
...
# {#bubble_pack_psymbol}
[#](#bubble_pack_psymbol) bubble_pack.**psymbol**([*symbol*])
...
# {#bubble_pack_psize}
[#](#bubble_pack_psize) bubblePack.**psize**([*size*])
...
# {#bubble_pack_pkey}
[#](#bubble_pack_pkey) bubblePack.**pkey**([*key*])
...
[#](#bubble_pack_get_computed_graphs) bubblePack.**getComputedGraphs**(*context*)
...
[#](#bubble_pack_get_visible_points) bubblePack.**getVisiblePoints**(*context*)
