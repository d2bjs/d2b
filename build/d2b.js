(function (exports,d3,d3Sankey) {
  ...
  function sankey$1 () {
    ...
    base(sankey, $$).addProp('sankey', d3Sankey.sankey()).addPropFunctor('size', { width: 960, height: 500 }).addPropFunctor('nodes', function (d) {
      ...
      return d.name;
    }).addPropFunctor('nodeLabel', function (d, key) {
      return key;
    }).addPropFunctor('nodeLabelWrapLength', Infinity).addPropFunctor('nodeDraggableX', false).addPropFunctor('nodeDraggableY', false).addPropFunctor('nodePreserveDragging', true).addPropFunctor('nodeColor', function (d, key) {
      return color(key);
