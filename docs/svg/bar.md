...
# {#bar_tooltip_graph}
[#](#bar_tooltip_graph) bar.**tooltipGraph**([*tooltip_graph*])
...
# {#bar_stack_by}
[#](#bar_stack_by) bar.**stackBy**([*stack_by*])
...
[#](#bar_get_computed_graphs) bar.**getComputedGraphs**(*context*)
...
[#](#bar_get_visible_points) bar.**getVisiblePoints**(*context*)
